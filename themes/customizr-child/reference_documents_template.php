<?php
/*
Template Name: reference_documents_template
*/
?>
...
if( !empty($_POST['doc_name'])){
	global $wpdb;
	$success = $wpdb->insert( docs, array( 'name' => $_POST['doc_name'], 'author' => $_POST['doc_author'], 'industry' => $_POST['doc_industry'] ,'doc_hlink' => $_POST['hlink']  ) );
    ...
    <div class="container" role="main">
        <div class="row">
            <?php do_action( '__sidebar' , 'left' ); ?>
				...
				<?php include 'reference_documents_populate.php';?>
